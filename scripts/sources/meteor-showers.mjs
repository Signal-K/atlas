...
const SHOWERS = [
  { name: 'Quadrantids', month: 1, day: 3, description: 'A short, sharp peak known for bright fireballs, radiating from the constellation Boötes.' },
  { name: 'Lyrids', month: 4, day: 22, description: 'One of the oldest recorded showers, radiating from Lyra, with fast, bright meteors.' },
  ...
  { name: 'Orionids', month: 10, day: 21, description: 'A second shower from Halley’s Comet debris, radiating from Orion with fast, occasionally bright meteors.' },
  { name: 'Leonids', month: 11, day: 17, description: 'Known for producing meteor storms roughly every 33 years; typical years show modest but fast, bright meteors.' },
  { name: 'Geminids', month: 12, day: 14, description: 'Widely considered the best shower of the year: high rates of bright, slow meteors, radiating from Gemini.' },
  { name: 'Ursids', month: 12, day: 22, description: 'A minor, often-overlooked shower near the winter solstice, radiating from Ursa Minor.' },
]
...
function eventForYear(shower, year) {
  ...
  return {
    ...
    starts_at: startsAt,
    ends_at: endsAt,
    ...(shower.imageUrl ? { image_url: shower.imageUrl, image_credit: shower.imageCredit ?? '' } : {}),
  }
}
