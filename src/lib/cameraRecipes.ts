...
export interface CameraRecipeEntry {
  ...
  devices: Record<DeviceId, DeviceRecipe>
}
...
export const CAMERA_RECIPES: Record<RecipeKey, CameraRecipeEntry> = {
  moon: {
    ...
    devices: {
      ...
      'nothing-phone-3a': {
        mode: 'Night mode off; manual exposure via the Nothing Camera app if available',
        lens: 'Main + 2x zoom',
        tripod: 'recommended',
        exposure: 'Lock exposure low — the Moon reads much brighter than the sky around it',
        focus: 'Tap-to-focus directly on the lunar disc',
      },
      generic: {
  ...
  bright_planet: {
    ...
    devices: {
      ...
      'nothing-phone-3a': {
        ...
        lens: 'Main',
        tripod: 'required',
        exposure: "Night mode's automatic multi-frame exposure",
        focus: 'Tap to focus on the brightest point in frame',
      },
      generic: {
  ...
  iss_pass: {
    ...
    devices: {
      ...
      'nothing-phone-3a': {
        mode: 'Night mode, longest duration setting',
        lens: 'Main',
        tripod: 'required',
        exposure: "Let Night mode run its full capture duration",
  ...
  meteor_shower: {
    ...
    devices: {
      ...
      'nothing-phone-3a': {
        ...
        lens: 'Main',
        tripod: 'required',
        exposure: "Longest Night mode duration, repeated",
        focus: 'Focus on a bright star, then lock',
      },
      generic: {
        mode: 'Night mode if available',
        lens: 'Main',
  ...
  conjunction: {
    ...
    devices: {
      ...
      'nothing-phone-3a': {
        ...
        lens: 'Main',
        tripod: 'recommended',
        exposure: "Automatic Night mode exposure",
  ...
  milky_way: {
    ...
    devices: {
      ...
      'nothing-phone-3a': {
        ...
        lens: 'Main (widest available)',
        tripod: 'required',
        exposure: 'The longest Night mode duration available',
