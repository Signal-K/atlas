...
// to seed location-specific events (currently ISS passes). Also used as the
// manual-location picker (Settings, Dashboard's "Browse the world") — it is
// NOT used to snap real geolocation coordinates anymore (see
